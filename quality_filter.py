...
def _classify(title: str, result: dict):
    """给文章打分类标签"""
    cats = [
        ("科技数码", r"AI|人工智能|GPT|大模型|芯片|手机|苹果|华为|小米|特斯拉|编程|代码|开源|算法|互联网|软件|硬件|机器人|自动驾驶|新能源|电池|半导体|无人机|卫星|航天"),
        ("商业财经", r"公司|企业|上市|融资|投资|市场|股价|收购|合并|金价|油价|房地产|经济|金融|银行|理财|赚钱|副业|变现|商业|品牌|行业|产业|贸易|关税|供应链"),
        ("职场成长", r"职场|工作|面试|跳槽|升职|薪资|中年|管理|领导|团队|效率|自律|习惯|认知|思维|成长|学习|读书|技能|方法|底层|逻辑"),
        ("社会民生", r"政策|医保|养老|退休|教育|高考|中考|房价|医疗|农村|城市|结婚|离婚|生育|社保|公积金|工资|补贴|限购|调控|拆迁"),
        ("娱乐八卦", r"明星|演员|歌手|导演|综艺|电影|电视剧|热播|开播|上线|恋情|出轨|八卦|爆料|红毯|走秀|代言|直播|网红"),
        ("情感生活", r"感情|爱情|恋爱|婚姻|家庭|孩子|父母|朋友|自己|人生|活着|生活|日子|女人|男人|夫妻|婆媳|闺蜜"),
    ]
